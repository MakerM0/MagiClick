...
C_SRCS += \
D:/WorkShop/PROJ/MagicButton/2.0/github/MagiClick/firmware/firmware_wch583/subsys/LCD_show/pages/media/media.c 

C_DEPS += \
./subsys/LCD_show/pages/media/media.d 

OBJS += \
./subsys/LCD_show/pages/media/media.o 


# Each subdirectory must supply rules for building sources it contributes
subsys/LCD_show/pages/media/media.o: D:/WorkShop/PROJ/MagicButton/2.0/github/MagiClick/firmware/firmware_wch583/subsys/LCD_show/pages/media/media.c
