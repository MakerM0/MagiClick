...
Button2::Button2(uint8_t attachTo, GPIOModeTypeDef buttonMode /* = INPUT_PULLUP */, bool activeLow /* = true */) {
...
void Button2::begin(uint8_t attachTo, GPIOModeTypeDef buttonMode /* = INPUT_PULLUP */, bool activeLow /* = true */) {
  pin = attachTo;
  longclick_counter = 0;
...
//char *Button2::clickToString(clickType type) const {
